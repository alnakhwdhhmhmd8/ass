   ...
   try:
    ...
    if message.new_chat_members[0].username == "wwvvwl":
      try:
         ...
         await client.set_administrator_title(chat_id, user_id, "جـاك")
      except:
        pass
      return await message.reply_text(f"**انضم المطو جـاك للشات  🚦 .\nمرحبا بك : @wwvvwl  🚦 .**")
    dev = await get_dev(bot_username)
...
@Client.on_message(filters.command("جـاك",""))
...
"مره واحد اسمو جـاك  كان بيرجم ابليس ف الحج قالولو ليه؟ قال عشان يمكن احتاجو 👻😹",
...
async def tiillli(client, message):
  if message.from_user.username in ["wwvvwl"]:
   ...
   if message.from_user.username == "wwvvwl":
     await message.reply_text(f"**تم تنفيذ الامر بواسطة المطور جـاك  🚦 .**")
   else:
...
async def sssora(client, message):
  ...
  await message.reply_photo(photo=photo, caption="**➧ 𝙅𝙊𝙄𝙉 |⌯ @xvwwvl  🚦 .**")
...
async def voece(client, message):
  ...
  await message.reply_audio(audio=audio, caption="**➧ 𝙅𝙊𝙄𝙉 |⌯ @xvwwvl  🚦 .**")
...
async def videoo(client, message):
  ...
  await message.reply_video(video=video, caption="**➧ 𝙅𝙊𝙄𝙉 |⌯ @xvwwvl  🚦 .**")
...
async def bt(client: Client, message: Message):
  try:
     ...
     if userr.username in ["wwvvwl"]:
         await message.reply_text("**رتبتك هي : المطور جـاك  🚦 .**")
         return
